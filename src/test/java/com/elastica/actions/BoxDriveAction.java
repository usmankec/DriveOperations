...
import com.elastica.webpage.BoxDrive;
import com.elastica.webpage.DriveLogin;


public class BoxDriveAction extends BasePage implements DriveLogin, BoxDrive {
	private static final Logger logger = TestLogging.getLogger(BoxDriveAction.class);
