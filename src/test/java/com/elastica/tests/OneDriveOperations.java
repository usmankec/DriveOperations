...
import com.elastica.actions.OneDriveAction;
...
public class OneDriveOperations extends SeleniumTestPlan {
	private static final Logger logger = TestLogging.getLogger(OneDriveOperations.class);
    ...
    public void uploadFile() throws Exception {
    	...
    	OneDriveAction oneDriveAction= new OneDriveAction();
    	driveLoginAction.driveLogin(user);
    	oneDriveAction.clickUplaodLink();
    	oneDriveAction.uploadFileAutoIT("Test.docx");
    	Thread.sleep(5000);
    ...
    public void deleteFile() throws Exception {
    	...
    	OneDriveAction oneDriveAction= new OneDriveAction();
    	driveLoginAction.driveLogin(user);
    	oneDriveAction.clickFileCheckbox(1);
    	oneDriveAction.clickManageLink();
    	oneDriveAction.clickDeleteLink();
    	Thread.sleep(5000);
    ...
    public void createFolder() throws Exception {
    	...
    	OneDriveAction oneDriveAction= new OneDriveAction();
    	driveLoginAction.driveLogin(user);
    	oneDriveAction.clickCreateLink();
    	oneDriveAction.clickCreateFolderLink();
    	oneDriveAction.typeInFolderNameTextbox("Folder2");
    	oneDriveAction.clickCreateFolderButton();
    	Thread.sleep(5000);
    }
    ...
    public void createTxtFile() throws Exception {
    	...
    	driveLoginAction.driveLogin(user);
    	oneDriveAction.clickCreateLink();
    	oneDriveAction.clickCreateFileLink("TXTFILE", "");
    	Thread.sleep(5000);
    ...
    public void createWordFile() throws Exception {
    	...
    	driveLoginAction.driveLogin(user);
    	oneDriveAction.clickCreateLink();
    	oneDriveAction.clickCreateFileLink("WORDFILE", "");
    	Thread.sleep(5000);
    ...
    public void createExlFile() throws Exception {
    	...
    	driveLoginAction.driveLogin(user);
    	oneDriveAction.clickCreateLink();
    	oneDriveAction.clickCreateFileLink("EXLFILE", "");
    	Thread.sleep(5000);
    ...
    public void createPptFile() throws Exception {
    	...
    	driveLoginAction.driveLogin(user);
    	oneDriveAction.clickCreateLink();
    	oneDriveAction.clickCreateFileLink("PPTFILE", "");
    	Thread.sleep(5000);
    ...
    public void createOnenoteFile() throws Exception {
    	...
    	driveLoginAction.driveLogin(user);
    	oneDriveAction.clickCreateLink();
    	oneDriveAction.clickCreateFileLink("ONENOTE", "");
    	Thread.sleep(20000);
    ...
    public void createExlSurveyFile() throws Exception {
    	...
    	driveLoginAction.driveLogin(user);
    	oneDriveAction.clickCreateLink();
    	oneDriveAction.clickCreateFileLink("EXLSURVEY", "");
    	Thread.sleep(5000);
