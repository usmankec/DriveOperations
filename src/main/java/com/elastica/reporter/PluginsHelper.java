...
import com.elastica.reporter.pluginmodel.Method;
import com.elastica.reporter.pluginmodel.Page;
import com.elastica.reporter.pluginmodel.Plugin;
import com.elastica.reporter.pluginmodel.SeleniumTestsPlugins;
import com.elastica.reporter.pluginmodel.Test;
import com.elastica.webelements.IPage;
...
public class PluginsHelper {
    ...
    public void loadPlugins(final File path) {
        ...
        try {
            ...
            JAXBContext jc = JAXBContext.newInstance("com.elastica.reporter.pluginmodel");
